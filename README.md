...
- Replace `dianakerekesha` with your Github username in the [DEMO LINK](https://dianakerekesha.github.io/react_people-table-advanced/) and add it to the PR description.
